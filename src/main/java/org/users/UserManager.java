...
/**
 * Interface responsible for managing the list of users maintained by the application.
 * It should provide he following functionalities:
 * 	- add new users to the list of users
 *  - update information of a user already in the list
 *  - delete information of a user already in the list
 * To fulfil the operations, the methods should consume the REST APIs available at: https://reqres.in
 */
...
public interface UserManager {
	...
	/**
	 * Update the job title of a user currently in the list by consuming the REST API: UPDATE/PUT or PATCH (https://reqres.in)
